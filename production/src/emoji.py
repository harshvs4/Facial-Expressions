...
def show_subject():
    cap1 = cv2.VideoCapture(0)  # 0 = accesses webcam
    ...
    bounding_box = cv2.CascadeClassifier('C:/Users/navishar/Anaconda3/envs/tensorflow/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
